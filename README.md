...
**AI Resume Analyzer** es una aplicación web full-stack construida con React, React Router, TypeScript y TailwindCSS. Permite a los usuarios subir su currículum, analizarlo con inteligencia artificial vía Puter, obtener feedback personalizado y visualizar resultados de manera interactiva.
...
- El análisis de CV se realiza enviando el PDF y un prompt personalizado (según la vacante) a través de Puter AI.
